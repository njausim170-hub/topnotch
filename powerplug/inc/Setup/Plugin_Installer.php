...
final class Plugin_Installer implements Bootable {
	...
	public static function manifest(): array {
		return [
			...
			[ 'slug' => 'wordpress-seo',            'name' => 'Yoast SEO',                   'required' => false, 'type' => 'repo' ],
			...
			[ 'slug' => 'litespeed-cache',          'name' => 'LiteSpeed Cache',             'required' => false, 'type' => 'repo' ],
			...
			[ 'slug' => 'merchant-compliance-inspector',     'name' => 'Merchant Compliance Inspector', 'required' => true, 'type' => 'bundled' ],
